...
namespace VirtualFileSystem.Annotations
{
    /// <summary>
    ...
    /// <summary>
    /// Contains common helper validation methods.
    /// </summary>
    public sealed class Validate
    {
        /// <summary>
        /// Checks if argument is not <see langword="null"/>.
        /// </summary>
        /// <typeparam name="T">Type of argument, class.</typeparam>
        ...
        /// <summary>
        /// Checks if string argument is not <see langword="null"/> or empty.
        /// </summary>
        /// <param name="obj">The argument to check.</param>
        /// <param name="name">The argument name.</param>
        /// <exception cref="ArgumentException"><c>ArgumentException</c>.</exception>
        public static void ArgumentNotNull(string obj, string name)
        {
